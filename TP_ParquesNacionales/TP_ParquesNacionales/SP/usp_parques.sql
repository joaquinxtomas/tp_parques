...
BEGIN
    ...
    INSERT INTO parques.Parque (nombre, id_tipo_parque, region, latitud, longitud, superficie) --si no corto llegue a el insert
    VALUES (@nombre, @id_tipo_parque, @region, @latitud, @longitud, @superficie);
END
GO
