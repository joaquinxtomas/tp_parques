...
RESTORE DATABASE ParquesNacionales
    FROM DISK = '\\192.168.1.56\SQLBackup\ParquesNacionales_FULL_20260630.bak'
    WITH NORECOVERY, STATS = 10;

RESTORE DATABASE ParquesNacionales
    FROM DISK = '\\192.168.1.56\SQLBackup\ParquesNacionales_DIFF_20260630.bak'
    WITH NORECOVERY, STATS = 10;
...
RESTORE LOG ParquesNacionales
    FROM DISK = '\\192.168.1.56\SQLBackup\ParquesNacionales_LOG_20260630_2015.bak'
