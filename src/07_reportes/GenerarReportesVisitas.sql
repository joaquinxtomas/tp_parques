...
BEGIN
	...
	--SELECT p.id_parque AS PARQUE,p.nombre,e.id_entrada,e.fecha,e.forma_pago,tv.cantidad,tv.subtotal FROM parques.Parque as p INNER JOIN ventas.Entrada as e ON e.id_parque = p.id_parque INNER JOIN ventas.TicketVisitante AS tv ON e.id_entrada = tv.id_ticket
